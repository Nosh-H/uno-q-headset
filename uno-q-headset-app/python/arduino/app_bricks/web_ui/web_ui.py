...
from python.arduino.app_peripherals.camera.base_camera import BaseCamera
...
class WebUI:
    ...
    def start(self):
        ...
        if self._use_tls:
            from python.arduino.app_utils.tls_cert_manager import TLSCertificateManager
    ...
    def expose_camera(self, path: str, camera: BaseCamera, jpeg_quality: int = 80):
        ...
        from python.arduino.app_utils.image import compress_to_jpeg
